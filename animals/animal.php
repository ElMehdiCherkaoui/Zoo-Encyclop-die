<DOCTYPE html>
    ...
    <body class="bg-gray-50 font-sans">
        ...
        <main class="max-w-6xl mx-auto p-8">
            ...
            <button class="block mx-auto mb-6 bg-teal-600 text-white px-4 py-2 rounded hover:bg-teal-700">
                Add Animal
            </button>
        ...
        function displayAnimals(animals) {
            ...
            animals.forEach(a => {
                const card = `
            <div class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition p-4">
                <img src="../img/${a.Image}" alt="${a.Nom}" class="w-full h-40 object-cover rounded-lg mb-3">
                <h3 class="text-xl font-semibold text-teal-700 mb-1">${a.Nom}</h3>
                <p class="text-gray-600 text-sm">Type: ${a.Type_alimentaire}</p>
                <p class="text-gray-600 text-sm">Habitat: ${a.NomHab ?? "Unknown"}</p>
